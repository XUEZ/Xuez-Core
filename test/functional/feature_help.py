...
"""Verify that starting xuez with -h works as expected."""

from test_framework.test_framework import XUEZTestFramework
from test_framework.util import assert_equal

class HelpTest(XUEZTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xuez with -h for help text")
        ...
        self.log.info("Start xuez with -version for version information")
        ...
        self.log.info("Start xuezd with -fakearg to make sure it does not start")
