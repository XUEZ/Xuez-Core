...
By default, xuezd will dump mempool on shutdown and
...
class MempoolPersistTest(XUEZTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent xuezd from writing mempool.dat to disk. Verify that `savemempool` fails")
