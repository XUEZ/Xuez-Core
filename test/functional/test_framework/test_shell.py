...
class TestShell:
    """Wrapper Class for XUEZTestFramework.

    The TestShell class extends the XUEZTestFramework
    ...
    class __TestShell(XUEZTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by XUEZTestFramework child class.
            self.num_nodes = 1
