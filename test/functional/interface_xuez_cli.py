...
# The block reward of coinbaseoutput.nValue (50) XUEZ/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 XUEZ/block.
BLOCKS = 101
...
class TestXUEZCli(XUEZTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `xuez-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and xuez-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 XUEZ) to the default wallet.
            ...
            # Test xuez-cli -generate with -rpcwallet in multiwallet mode.
