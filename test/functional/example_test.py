...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the XUEZTestFramework
    pass


class ExampleTest(XUEZTestFramework):
    # Each functional test is a subclass of the XUEZTestFramework class.
    ...
    def custom_method(self):
        ...
        XUEZTestFramework class so other tests can use it."""
