...
class P2PPermissionsTests(XUEZTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].xuezconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].xuezconf, 'w', encoding="utf8") as f:
            f.write(newText)
