...
const std::string CURRENCY_UNIT = "XUEZ"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    XUEZ_KVB,      //!< Use XUEZ/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from XUEZ/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::XUEZ_KVB) const;
