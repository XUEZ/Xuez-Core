...
/* A AEAD class for ChaCha20-Poly1305@xuez.
 *
 ...
 *
 * The chacha20-poly1305@xuez combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@xuez cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@xuez are relatively fast in
