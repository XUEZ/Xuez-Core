    ...
    platformStyle(_platformStyle)
{
    ...
    // normal xuez address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying xuez address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &XUEZAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
