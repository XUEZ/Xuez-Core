    ...
    mapper(nullptr)
{
    ...
    ui->xuezAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->xuezAtStartup);
    ...
    ui->xuezAtStartup->setToolTip(ui->xuezAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->xuezAtStartup->setText(ui->xuezAtStartup->text().arg(PACKAGE_NAME));

    ui->openXUEZConfButton->setToolTip(ui->openXUEZConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new XUEZUnits(this));
...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    if(_model)
    {
        ...
        static constexpr uint64_t nMinDiskSpace = (MIN_DISK_SPACE_FOR_BLOCK_FILES / GB_BYTES) + (MIN_DISK_SPACE_FOR_BLOCK_FILES % GB_BYTES ? 1 : 0); // Fix order of operations so that adding occurs last
...
{
    /* Main */
    mapper->addMapping(ui->xuezAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openXUEZConfButton_clicked()
{
