...
/**
  XUEZ GUI main class. This class represents the main window of the XUEZ UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class XUEZGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit XUEZGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~XUEZGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a xuez wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed XUEZ Transaction from file or clipboard */
