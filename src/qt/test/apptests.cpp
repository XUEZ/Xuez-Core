...
//! Entry point for XUEZApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &XUEZApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for XUEZGUI tests.
void AppTests::guiTests(XUEZGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &XUEZGUI::consoleShown, this, &AppTests::consoleTests);
