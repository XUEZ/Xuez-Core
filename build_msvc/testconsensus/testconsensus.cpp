...
// xuez includes.
#include <..\src\script\xuezconsensus.h>
...
int main()
{
    std::cout << "xuezconsensus version: " << xuezconsensus_version() << std::endl;
    ...
    auto op0Result = xuezconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, xuezconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
