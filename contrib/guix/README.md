# Bootstrappable XUEZ Core Builds

This directory contains the files necessary to perform bootstrappable XUEZ
Core builds.
...
- 24GB of free disk space on the partition that the XUEZ Core git repository
  resides in
...
For a XUEZ Core depends development environment, simply invoke
...
From the top of a clean XUEZ Core repository:
...
To use dongcarl's substitute server for XUEZ Core builds after having
