...
export BITCOIN_CONFIG="--enable-reduce-exports --without-boost-process --enable-suppress-external-warnings --disable-dependency-tracking --disable-tests --disable-gui-tests --disable-bench"
