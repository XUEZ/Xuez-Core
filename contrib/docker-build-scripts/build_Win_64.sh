...
export DOCKER_PACKAGES=${DOCKER_PACKAGES:-build-essential libtool autotools-dev automake pkg-config bison bsdmainutils curl ca-certificates ccache python3 rsync git procps nsis g++-mingw-w64-x86-64 g++-mingw-w64-i686 wine-binfmt wine64 file}
...
COPYBINS () {
  ...
  DOCKER_EXEC cp $BASE_ROOT_DIR/xuez*setup.exe /xueztmp/xuez-$VER-win64-setup.exe
