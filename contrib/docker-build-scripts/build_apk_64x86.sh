...
## run with -
##  bash contrib/build-docker-scripts/buildapk_64x86.sh
...
export BITCOIN_CONFIG="--disable-ccache --enable-suppress-external-warnings --disable-dependency-tracking  --disable-tests --disable-gui-tests --disable-bench"
...
DEP_OPTS=""
BUILDHOST="x86_64-linux-android"
...
DOCKER_EXEC "cd src/qt && make $MAKEJOBS && ANDROID_HOME=${ANDROID_HOME} ANDROID_NDK_HOME=${ANDROID_NDK_HOME} make apk" && COPYAPK
