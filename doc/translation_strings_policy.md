...
This document provides guidelines for internationalization of the XUEZ Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xuez_en.ts` remains unchanged.
