XUEZ Core version 0.10.4 is now available from:

  <https://xuez.org/bin/xuez-core-0.10.4/>
...
- #6953 `43c2789` Split xuez-tx into its own package
- #6953 `dfe0d4d` Include xuez-tx binary on Debian/Ubuntu
