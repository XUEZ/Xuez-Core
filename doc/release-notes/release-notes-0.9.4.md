XUEZ Core version 0.9.4 is now available from:

  https://xuez.org/bin/0.9.4/
...
this update is incompatible with the XUEZ system and could lead to consensus
forks.

XUEZ Core released binaries from https://xuez.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~xuez/+archive/ubuntu/xuez
- A third-party or self-compiled XUEZ Core

upgrade to XUEZ Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
