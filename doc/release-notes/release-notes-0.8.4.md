XUEZ-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/xuez/files/XUEZ/xuez-0.8.4/
...
code, causing the XUEZ-Qt or xuezd process to crash.
...
Linux: clicking on xuez: links was broken if you were using
a Gnome-based desktop.

Fix a hang-at-shutdown bug that only affects users that compile
their own version of XUEZ against Boost versions 1.50-1.52.
