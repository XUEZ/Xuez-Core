XUEZ Core version 0.13.2 is now available from:

  <https://xuez.org/bin/xuez-core-0.13.2/>
...
- #8908 `4a974b2` Update xuez-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xuez-tx to create v2 transactions (xuezdrak)
