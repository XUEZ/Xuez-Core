XUEZ-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/xuez/files/XUEZ/xuez-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the XUEZ
...
New/changed settings (command-line or xuez.conf file)
--------------------------------------------------------
