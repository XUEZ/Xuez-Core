XUEZ-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/xuez/files/XUEZ/xuez-0.8.6/
...
- Fix XUEZ-Qt startup crash when clicking dock icon on OSX 
