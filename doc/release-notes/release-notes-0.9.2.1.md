XUEZ Core version 0.9.2.1 is now available from:

  https://xuez.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XUEZ to 0.01 XUEZ
...
- Fix "Start xuez on system login"
