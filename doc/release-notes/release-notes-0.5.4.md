XUEZ version 0.5.4 is now available for download at:
http://sourceforge.net/projects/xuez/files/XUEZ/xuez-0.5.4/
...
http://gitorious.org/xuez/xuezd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix XUEZ-Qt notifications under Growl 1.3.
Increase required age of XUEZ-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxXUEZ properly when installing XUEZ-Qt over it. (Windows)
